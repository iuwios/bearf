...
if (console && console.log) {
  console.log('Expanse theme ('+theme.settings.themeVersion+') by ARCH$)A&.TYPE | Learn more at https://archetypethemes.co');
}
...
(function(){
  ...
  (function() {
    ...
    document.body.addEventListener('touchstart', function(i) {
      if (!i.target.closest('.flickity-slider-expanse')) {
        return e = !1;
        void 0;
      }
      e = !0;
  ...
  theme.Slideshow = (function() {
    ...
    function slideshow(el, args) {
      ...
      function avoidReflow(el) {
        ...
        style.innerHTML = `#${el.id} .flickity-viewport-expanse{height:${firstChild.offsetHeight}px}`;
  ...
  theme.headerNav = (function() {
    ...
    function init() {
      ...
      //fwindow.on('load' + config.namespace, resizeLogo);
  ...
  theme.Photoswipe = (function() {
    var selectors = {
      ...
      slideshowTrack: '.flickity-viewport-expanse ',
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      onSlideChange: function(index) {
        ...
        var nextSlide = this.settings.imageSetName ?
                        this.cache.mainSlider.querySelectorAll('.flickity-slider-expanse .product-main-slide')[index] :
